...
## **1-alphabet.c**:
**Prototype**: _void print_alphabet(void)_
...
**Prototype**: _void print_alphabet_x10(void)_
...
## **5-sign.c**:
**Prototype**: _int print_sign(int n)_
...
## **11-print_to_98.c**:
**Prototype**: _void print_to_98(int n)_
...
## **100-times_table.c**:
**Prototype**: _void print_times_table(int n)_
